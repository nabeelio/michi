...
public sealed class MPathFileSystemMoveTests : IDisposable {
    private readonly string _tempRoot;

    public MPathFileSystemMoveTests()
    {
        _tempRoot = Path.Combine(Path.GetTempPath(), $"michi-fs-move-{Guid.NewGuid():N}");
    ...
    public void MoveTo_directory_Fail_policy_throws_on_collision()
    {
        ...
        // target.
        var resolved = MPath.From(Path.Combine(dstDir.Value, srcDir.Name));
    ...
    public void MoveTo_directory_DirectoryReplace_at_resolved_target_replaces_tree()
    {
        ...
        srcDir.MoveTo(MPath.From(TempPath("dst-tree")), ExistsPolicy.DirectoryReplace);
    ...
    public void MoveTo_directory_DirectoryMerge_merges_file_contents()
    {
        ...
        srcDir.MoveTo(MPath.From(TempPath("dst-tree")), ExistsPolicy.DirectoryMerge);
    ...
    public void MoveTo_directory_MergeAndOverwrite_overwrites_same_named_files()
    {
        ...
        srcDir.MoveTo(MPath.From(TempPath("dst-tree")), ExistsPolicy.MergeAndOverwrite);
    ...
    public void MoveTo_directory_MergeAndSkip_preserves_existing_dest_files()
    {
        ...
        srcDir.MoveTo(MPath.From(TempPath("dst-tree")), ExistsPolicy.MergeAndSkip);
