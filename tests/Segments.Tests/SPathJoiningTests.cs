...
public class SPathJoiningTests {
    ...
    public void SlashOperator_BasicJoin()
    {
        ...
        (SPath.From("/foo") / "bar").ToUnixString().ShouldBe("/foo/bar");
    }
    ...
    public void SlashOperator_LeadingSlashOnRhs_IsStripped()
    {
        ...
        (SPath.From("/var/www") / "/etc").ToUnixString().ShouldBe("/var/www/etc");
    }
    ...
    public void SlashOperator_LeadingBackslashOnRhs_IsStripped()
    {
        ...
        (SPath.From("/var") / "\\etc").ToUnixString().ShouldBe("/var/etc");
    }
    ...
    public void SlashOperator_RhsWithInternalSeparators_JoinsAndNormalizes()
    {
        ...
        (SPath.From("/a") / "b/c/d").ToUnixString().ShouldBe("/a/b/c/d");
    }
    ...
    public void SlashOperator_RhsWithDoubleDot_Traverses()
    {
        ...
        (SPath.From("/a/b") / "../c").ToUnixString().ShouldBe("/a/c");
    }
    ...
    public void Join_ChainsSegments()
    {
        ...
        SPath.From("/a").Join("b", "c", "d").ToUnixString().ShouldBe("/a/b/c/d");
    }
    ...
    public void Joining_ProducesSegmentsAndEquality()
    {
        ...
        joined.ShouldBe(SPath.From("/a/b/c"));
    }
}
