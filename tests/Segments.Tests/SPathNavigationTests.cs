...
public class SPathNavigationTests {
    ...
    public void Parent_ReturnsContainingDirectory()
    {
        ...
        SPath.From("/foo/bar/baz").Parent.ToUnixString().ShouldBe("/foo/bar");
        SPath.From("/foo").Parent.ToUnixString().ShouldBe("/");
    }
    ...
    public void Parent_OnRoot_ThrowsNoParentException()
    {
        ...
        var ex = Should.Throw<NoParentException>(() => { _ = SPath.From("/").Parent; });
    ...
    public void TryGetParent_OnNonRoot_ReturnsTrueWithResult()
    {
        ...
        SPath.From("/foo/bar").TryGetParent(out var parent).ShouldBeTrue();
    ...
    public void TryGetParent_OnRoot_ReturnsFalseWithNull()
    {
        ...
        SPath.From("/").TryGetParent(out var parent).ShouldBeFalse();
        parent.ShouldBeNull();
    }
    ...
    public void Up_WalksNLevels()
    {
        ...
        SPath.From("/a/b/c/d").Up(2).ToUnixString().ShouldBe("/a/b");
    }
    ...
    public void Up_ExceedsDepth_ThrowsNoParentException_WithBothValuesInMessage()
    {
        ...
        var p = SPath.From("/foo/bar"); // Depth = 2
    ...
    public void Parent_Chained_AtRoot_ThrowsNoParentException()
    {
        ...
        Should.Throw<NoParentException>(() => { _ = SPath.From("/foo").Parent.Parent; });
    }
}
