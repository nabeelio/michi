...
/// <summary>
/// Immutable settings for <see cref="SPath" /> construction. Derive custom options from
/// <see cref="Default" /> via `with`:
/// <code>
/// var opts = SPathOptions.Default with { ExpandTilde = true };
/// var p = SPath.From("~/config", opts);
/// </code>
/// </summary>
/// <remarks>
...
/// {
///     public static SPathOptions Options { get; } = SPathOptions.Default with
///     {
...
/// </para>
/// </remarks>
public sealed record SPathOptions {
    /// <summary>
    ...
    /// </summary>
    public static SPathOptions Default { get; } = new();
}
