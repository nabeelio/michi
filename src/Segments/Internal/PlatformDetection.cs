...
/// </summary>
/// <remarks>
/// Single source of truth for path-comparison semantics. Equality and hashing elsewhere in Segments
...
internal static class HostOs {
    ...
    /// <summary>
    /// <see cref="StringComparison" /> used by SPath equality, hashing, and ordering. Case-insensitive
